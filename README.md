...
There are 3 vars:<br/>
- app_name: app of your name<br/>
- app_path: the domain where your app is running (by default this's a localhost)<br/>
- database: the creditials for your database (by default host:localhost, user:root, password:, db:)<br/>
<br/>
<br/>
<br/>
<h1>Model</h1><br/>
...
Properties:<br/>
    - attributes: <br/>
        - id (integer, auto managed, you should not edit that), <br/>
        - [your own] (columns in db, each of them has to be declared as type of Field), <br/>
        - TABLE (const string, name of a table in db, require to override in each derived class)<br/>
    - methods:<br/>
        - constructor:<br/>
            - arguments: none<br/>
        - __toString: <br/>
        ...
        - get_object_or_404:<br/>
            ...
            - arguments: $id<br/>
            - returns: single object or throw 404 if object is not exists<br/>
        - filter:<br/>
            - static public<br/>
        ...
        - max:<br/>
            ...
            - returns: single object with max indicated value<br/>
        - min:<br/>
            - static public<br/>
            - purpose: find object with min value in column<br/>
            - arguments: $col_name (column's name)<br/>
            - returns: single object with min indicated value<br/>
        - save:<br/>
            - public<br/>
            ...
            - returns: none or if $commit=true id which will be assigned to this object when you will save it<br/>
        - delete:<br/>
            - public<br/>
...
List of commands:<br/>
- migrate - (auto-migrate tables into database based of models)<br/>
- view [name] - create new view<br/>
- model [name] - create new model<br/>
- form [name] - create new form<br/>
<br/>
<br/>
<br/>
<h1>Urls</h1><br/>
...
- $path - path which will trigger on that url<br/>
- $view - name of target view<br/>
- $action - name of target method in target view<br/>
- $http_method - supported http method (by default is 'GET')<br/>
<br/>
<br/>
<br/>
<h1>Requests</h1><br/>
